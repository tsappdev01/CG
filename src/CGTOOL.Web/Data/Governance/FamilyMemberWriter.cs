...
public class FamilyMemberWriter(IStoredProcedureExecutor sp) : IFamilyMemberWriter
{
    ...
    public Task UpdateAsync(FamilyMember familyMember) => sp.ExecuteAsync("dbo.usp_FamilyMember_Update",
        ...
        new SqlParameter("@EmiratesIdNumber", (object?)familyMember.EmiratesIdNumber ?? DBNull.Value),
        new SqlParameter("@EmiratesIdExpiryDate", (object?)familyMember.EmiratesIdExpiryDate ?? DBNull.Value),
        new SqlParameter("@PassportPath", (object?)familyMember.PassportPath ?? DBNull.Value),
        new SqlParameter("@PassportNumber", (object?)familyMember.PassportNumber ?? DBNull.Value),
        new SqlParameter("@PassportExpiryDate", (object?)familyMember.PassportExpiryDate ?? DBNull.Value),
